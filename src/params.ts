...
function notError<T>(t: T | Error): T {
...
export default {
  acknowledgementPrivateKey: notError(
    PrivateKey.fromBech('privhi1md85cpl8n87h7aw599hpgdfaqa52rvm84fxh5jeexgvc6gpvmcxq0f9v3f')
  ),
  acknowledgementPublicKey: notError(
    PublicKey.fromBech('pubhi1q0uxh43waf75mjxle0wsygm6em590kula0agetmx6rhcuvsfnrqv7kxa5dv')
  ),
