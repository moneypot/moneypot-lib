...
export default class LightningInvoice {
  ...
  hash(): Hash {
    return Hash.fromMessage('LightningInvoice', buffutils.fromString(this.toPOD()));
  }
...
function decode(paymentRequest: string): PaymentRequestObject {
...
function encode(paymentRequest: PaymentRequestObject) {
