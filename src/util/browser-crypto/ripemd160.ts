...
function readInt32LE(buff: Uint8Array, offset: number) {
  throw new Error("todo....");
}

function writeInt32LE(buff: Uint8Array, value: number, offset: number) {
  throw new Error("todo...");
}

function writeUInt32LE(buff: Uint8Array, value: number, offset: number) {
  throw new Error("todo...");
}
