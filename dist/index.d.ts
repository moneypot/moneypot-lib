...
export declare type AcknowledgedTransferBounty = Acknowledged<TransferBounty, POD.TransferBounty>;
export declare type AcknowledgedTransferHookout = Acknowledged<TransferHookout, POD.TransferHookout>;
export declare type AcknowledgedTransferHookin = Acknowledged<TransferHookin, POD.TransferHookin>;
export { Buffutils };
