...
export default class RIPEMD160 {
    ...
    _update() {
        let words = ARRAY16;
        let view = new DataView(this._block.buffer, this._block.byteOffset);
        for (let j = 0; j < 16; ++j) {
            words[j] = view.getInt32(j * 4, true);
        }
        var al = this._a | 0;
        var bl = this._b | 0;
        var cl = this._c | 0;
    ...
    _digest() {
        ...
        view.setInt32(0, this._a, true);
        view.setInt32(4, this._b, true);
        view.setInt32(8, this._c, true);
        view.setInt32(12, this._d, true);
        view.setInt32(16, this._e, true);
