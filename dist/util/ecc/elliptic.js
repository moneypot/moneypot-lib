import { mod, powmod, secp256k1 as curve, bufferFromBigInt, bufferToBigInt, pointFromBuffer, pointToBuffer, bufferFromHex, } from './util';
...
export const INFINITE_POINT = new class {
    get x() {
...
//     return fastAdd(a, b)
// }
export function pointAdd(...points) {
...
export function pointMultiply(point, scalar) {
...
export function naiveMultiply(point, scalar) {
    scalar = scalar % curve.n;
