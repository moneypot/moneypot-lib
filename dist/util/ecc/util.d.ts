...
export declare const bigintToHex: (n: number | bigint) => string;
...
export declare function isEven(y: bigint): boolean;
...
export declare function standardGetEBIP340(Rx: bigint, Px: bigint, m: Uint8Array): bigint;
